...
// shared_ptr<Group> Loader::parseGroup(Json::Value val, ObservableVector<shared_ptr<Pixel>>& pixels, shared_ptr<Group> parent)
// {
...
// shared_ptr<Pixel> Loader::parsePixelReference(Json::Value val, ObservableVector<shared_ptr<Pixel>>& pixels, shared_ptr<Group> parent)
// {
